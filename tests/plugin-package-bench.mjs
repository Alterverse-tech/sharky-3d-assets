...
assert.match(widget, /设计人物资产/);
assert.match(widget, /CHARACTER_DESIGNER_URL/);
assert.match(bridge, /openExternal/);
assert.match(bridge, /redirectUrl: false/);
assert.match(bundle, /asset-center\/characters\/new/);
assert.match(bundle, /character-design-cta/);
